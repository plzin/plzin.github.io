...
<div class="theorem">
<div>Generators of $\ZI$</div>
$\ZI = (Z_0, \ldots, Z_d)$ where $d$ is the smallest integer such that $m$ divides $d!$.
...
so $c_k$ is a multiple of that $c$, i.e. $c_k=d_i\frac{m}{\gcd(k!, m)}$ and $N$ can be written
